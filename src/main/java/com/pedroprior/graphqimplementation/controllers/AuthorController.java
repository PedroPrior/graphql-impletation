package com.pedroprior.graphqimplementation.controllers;
...
public class AuthorController {
    ...
    Book addBook(@Argument BookInput book) {
        Author author = authorRepository.findById(book.authorId()).orElseThrow(() -> new IllegalArgumentException("Autor não encontrado"));
        Book b = new Book(
                book.title(),
                book.publisher(),
                author);
